  ...
  return (
    ...
    <CntSilabas>
      {data && data.obtenerNivel ? 
        <Prueba palabras={data.obtenerNivel.palabrasClave} 
          nombres={data.obtenerNivel.nombresClave} 
          letra={data.obtenerNivel.letra} 
          nivel={data.obtenerNivel.nivel}
          palabraGen={data.obtenerNivel.palabraGen}
          />
          : null 
      }
    </CntSilabas>
